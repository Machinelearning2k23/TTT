...
if uploaded_file is not None:
    ...
    producer = KafkaProducer(
        bootstrap_servers='joritz-kafka-cluster-kafka-bootstrap.kafka.svc.cluster.local:9092',
    ...
    while cap.isOpened():
        ...
        if frame is not None:
            ...
            if len(texts) > 0:
                ...
                message = {'frame_number': frame_nmr + 1, 'license_plates': texts}
                producer.send('license-detection', message)
